                ...
                <div
                    ...
                    <form>
                        ...
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
                             style='background-image: url("{{ asset('backend/media/misc/bg-1.jpg') }}")'>
                            <!--begin::Title-->
                    ...
                    <ul class="navi navi-hover py-4">
                        ...
                        <li class="navi-item active">
                            <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img
                                                            src="{{ asset('backend/media/svg/flags/128-spain.svg') }}"
                                                            alt=""/>
													</span>
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img
                                                            src="{{ asset('backend/media/svg/flags/162-germany.svg') }}"
                                                            alt=""/>
													</span>
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img
                                                            src="{{ asset('backend/media/svg/flags/063-japan.svg') }}"
                                                            alt=""/>
													</span>
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img
                                                            src="{{ asset('backend/media/svg/flags/195-france.svg') }}"
                                                            alt=""/>
													</span>
