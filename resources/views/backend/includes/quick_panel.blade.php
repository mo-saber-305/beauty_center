            ...
            <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                ...
                <div class="mb-15">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img
                                            src="{{ asset('backend/media/svg/misc/006-plurk.svg" class="h-50 align-self-') }}center"
                                            alt=""/>
									</span>
                        </div>
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{ asset('backend/media/svg/misc/015-telegram.') }}svg"
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img
                                            src="{{ asset('backend/media/svg/misc/003-puzzle.svg" class="h-50 align-self-') }}center"
                                            alt=""/>
									</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img
                                            src="{{ asset('backend/media/svg/misc/005-bebo.svg" class="h-50 align-self-') }}center"
                                            alt=""/>
									</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        <div class="symbol symbol-50 symbol-light mr-5">
									<span class="symbol-label">
										<img src="{{ asset('backend/media/svg/misc/014-kickstarter.') }}svg"
